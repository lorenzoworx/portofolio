...
export const projectData = [
  {
    id: "1",
    title: "Arogah Front End",
    liveLinkAvailable: true,
    description: `Arogah is an innovative e-commerce frontend designed to redefine the way you shop online.
     With an elegant and intuitive user interface, it provides a curated selection of products across various 
     categories, ensuring a delightful shopping experience. From easy navigation and advanced search capabilities 
     to personalized recommendations, Arogah tailors your journey to your preferences. Emphasizing security, our 
     platform features encrypted transactions and user data protection. Whether you're a buyer or a seller, Arogah 
  ...
  },
  {
    ...
    title: "Awesome Books",
    liveLinkAvailable: true,
    description: `Awesome Books is a simple website that displays a list of books and allows you to add and remove 
  ...
  },
  {
    ...
    description: `Book Warden is a comprehensive library management tool designed to streamline the process of recording, 
  ...
  },
  {
    ...
    title: "Chef Chapters",
    liveLinkAvailable: false,
    description: `Chef Chapters keeps track of all your recipes, ingredients, and inventory. It will allow you 
    to save ingredients, keep track of what you have, create recipes, and generate a shopping list based on what 
    you have and what you are missing from a recipe. Also, since sharing recipes is an important part of cooking 
